...
#%% load data
df_gpp = pd.read_csv(os.path.join(data_path, "grid_output","gpp_bleed.csv"))
...
full_county_stats.to_excel(os.path.join(data_path, "counties_output","counties_plants_capacity_by_type.xlsx"),index=False)
...
#%%
lines_capacity_stats = pd.read_excel(os.path.join(data_path, "counties_output","counties_lines_distance_by_capacity_bin.xlsx"))
...
statistics_counties.to_excel(os.path.join(data_path, "counties_output","counties_lines_plants_statistics.xlsx"),index=False)
