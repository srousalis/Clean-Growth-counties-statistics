...
## Structure:
The electricity grid data is located in the data/grid_output directory, and the output generated by the code is saved in data/counties_output. The final dataset produced by this replication package is counties_lines_plants_statistics.xlsx.
